#ifndef STAN_MATH_REV_MAT_FUNCTOR_INTEGRATE_ODE_BDF_BARE_HPP
#define STAN_MATH_REV_MAT_FUNCTOR_INTEGRATE_ODE_BDF_BARE_HPP
...
namespace stan {
  namespace math {
     ...
     */
    /* this function is already defined by the integrate_ode_bdf include
    ...
    */
     ...
     * stream.
     *
     * THIS VERSION IS openMP thread safe by never touching the AD
     * stack IF the Jacobian of the ode functor is analytically
     * defined by appropiate specialization of ode_system.
     *
    ...
    integrate_ode_bdf_bare(const F& f,
